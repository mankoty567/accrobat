 ...
 */
 const API = {
    ...
    getChallenge: (data) => {
        return fetch(`${host}/api/challenge/${data.challenge_id}?include=${data.include}`, {
            method: 'GET',
            headers: { 'Authorization': 'Bearer ' + window.localStorage.getItem('token') }
        }).then(checkStatus).then(res => res.json());
    },
    ...
    getMarkers: () => {
        return fetch(`${host}/api/challenge/${data.challenge_id}/point?include=${data.include}`, {
            method: 'GET',
            headers: { 'Authorization': 'Bearer ' + window.localStorage.getItem('token') }
        }).then(checkStatus).then(res => res.json());
    },
    ...
    getSegment: () => {
        return fetch(`${host}/api/segment/${data.segment_id}?include=${data.include}`, {
            method: 'GET',
            headers: { 'Authorization': 'Bearer ' + window.localStorage.getItem('token') }
        }).then(checkStatus).then(res => res.json());
    },
    ...
    getProgression: (data) => {
        return fetch(`${host}/api/participation/${data.participation_id}/whereiam`, {
            method: 'GET',
            headers: { 'Authorization': 'Bearer ' + window.localStorage.getItem('token') }
        }).then(checkStatus).then(res => res.json());
    }
