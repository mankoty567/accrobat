...
var routes = [
    ...
    },
    {
        ...
        description: 'A ne pas utiliser tel quel, cette route est la redirection depuis la connection',
        result: [
            {
                code: 203,
                content: 'Redirection sur le front avec dans le hash un JWT à échanger avec la route Whoami',
            },
        ],
    },
];
