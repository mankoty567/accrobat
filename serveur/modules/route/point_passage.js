...
module.exports.routes = [
  {
    ...
    func: [m.user_mdw.put_user, m.pointpassage_ctrl.get_pointpassage],
    name: 'Récupération des PointPassage',
    description: "Récupération des PointPassages d'un segment",
    query: [
      {
        param: 'include=segment',
        description: 'Met les segments dans pointStart et pointEnd',
      },
    ],
    result: [
      {
  ...
  },
  {
    ...
    func: [m.user_mdw.put_admin, m.pointpassage_ctrl.delete_pointpassage],
  ...
  },
  {
    method: 'POST',
    url: '/api/pointpassage/:id',
    func: [m.user_mdw.put_admin, m.pointpassage_ctrl.update_pointpassage],
